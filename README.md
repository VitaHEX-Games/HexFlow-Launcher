...
**Note:** 
If you're using an old version of RetroFlow (below v5) you will need to rename PSP and maybe PS1 games too, please see the guide here: [Legacy guide - Renaming PSP and PSX](https://github.com/jimbob4000/RetroFlow-Launcher/blob/main/docs/Legacy_guide_-_Renaming_PSP_and_PS1.md). 
